...
## Next Up
- Improve scraping UX (avoid user disruption while paging; consider new tab/background navigation).
- Invoice download pass (queued, throttled, retries) after order CSV is solid.
- Add minimal automated tests for parsers/CSV.
